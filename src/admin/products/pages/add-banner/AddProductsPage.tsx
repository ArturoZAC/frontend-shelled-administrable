...
import { addBannerSchema, type AddBannerForm } from "../../schemas/add-product.schema";
import { useProductsMutation } from "./hooks/useBannerMutation";
...
export const AddProductsPage = () => {
  ...
  return (
    ...
    ${createProductMutation.isPending ? "bg-gray-400 cursor-not-allowed" : ""}
  `}
